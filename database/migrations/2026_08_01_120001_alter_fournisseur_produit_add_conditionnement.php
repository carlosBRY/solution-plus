...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fournisseur_produit', function (Blueprint $table) {
            ...
            $table->foreignUlid('conditionnement_id')->constrained('conditionnements')->cascadeOnDelete();
            $table->decimal('prix_achat', 12, 2);
            $table->timestamps();

            $table->primary(['fournisseur_id', 'produit_id', 'conditionnement_id'], 'fp_cond_primary');
        });
    }
